...
class PPL_LL_based_gpt2_t5:
    def __init__(self, device="cuda", model_id="gpt2-medium"):
        ...
        self.D_ll_shreshold=0.00000001
    ...
    def __call__(self, sentence,mask_model_id,n_perturbations):
        ...
        d_ll=ll-mean_perturbed_ll
        score=d_ll/std_perturbed_ll

        

        if(d_ll!=0):
            if(d_ll>self.D_ll_shreshold):
                results["dPrediction"]=1                #1 means AI generated, 0 means human generated
                output1="is AI generated -d"
            else:
                results["dPrediction"]=0
                output1="is Human generated -d"
            if(score>self.Score_threshold):
                results["sPrediction"]=1
                output2="is AI generated -s"
            else:
                results["sPrediction"]=0
                output2="is Human generated -s"
        else:
            results["dPrediction"]=0
            output1="is AI generated -d"
        ...
        return results,output1,output2
