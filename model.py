...
class PPL_LL_based_gpt2_t5:
    ...
    def __call__(self, sentence,mask_model_id,base_model_id):
        """
        ...
        results["LL"] = ll
        results["Perturbed LL"] = sum(perturbed_ll)/len(perturbed_ll)
        results["D_LL"] = ll-sum(perturbed_ll)/len(perturbed_ll)
